...
```
implementation("com.spotify.confidence:openfeature-provider-android:0.1.8")
```
...
Where `0.1.8` is the most recent version of this SDK. Released versions can be found under "Releases" within this repository.
